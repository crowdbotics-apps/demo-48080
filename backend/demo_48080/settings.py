"""
Django settings for demo_48080 project.
...
WSGI_APPLICATION = 'demo_48080.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_48080 API",
    "DESCRIPTION": "API documentation for demo_48080 App",
    "VERSION": "v1",
}
